...
export async function getEasyAuctionContract({
  ...
  let contractAddress = "0x0b7fFc1f4AD541A4Ed16b40D8c37f0929158D101";
  if (chainId === 43114) {
    contractAddress = "0xb5D00F83680ea5E078e911995c64b43Fbfd1eE61";
  }
  const authenticator = new Contract(contractAddress, JSON.parse(json)).connect(
    ethers.provider,
  );
